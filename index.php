...
<div class="main_div">
      ...
      <span class="navbar-toggler-icon" style="background:white;"></span>
       ...
       <div class="collapse navbar-collapse text-center" id="collapsenavbar">
          <ul class="navbar-nav ml-auto">
              <li class="nav-item">
                  <a href="index.php" class="nav-link text-white "><span style="margin-left:90px ;font-size:22px; font-family:HGMaruGothicMPRO;" ><b>ABOUT</b></span></a></li>
              <li class="nav-item">
     ...
     <div class="container">
        ...
        <div class="row">
          ...
          <div class="transbox">
            ...
            <h1 class="main_text "><h2 style="color:#FFFFFF;font-size:42px; font-family:HGMaruGothicMPRO ;position:relative;margin-left:10px; top:10px;"><i><b>BANKING AT YOUR FINGERTIPS<i> <b> </h1>
  ...
  <section class="contactus" id="contact" >
        ...
        <div class="container headings text-center">
            ...
            <p>We're here to help and answer any queries you might have</p>
